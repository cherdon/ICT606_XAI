"""
Logistic Regression Binary Classification for Wine Quality (Premium vs Non-Premium) - FINETUNED VERSION.
...
4. Testing L1, L2, and ElasticNet regularization
...
Model: Logistic Regression - Finetuned
"""
import sys
import os
...
def hyperparameter_tuning(
    ...
    # Using 'saga' solver as it supports all penalty types
    param_distributions = {
...
def train_and_evaluate(
    ...
    if verbose:
        print("\n" + "=" * 60)
        print("LOGISTIC REGRESSION BINARY CLASSIFICATION (FINETUNED)")
        print("=" * 60)

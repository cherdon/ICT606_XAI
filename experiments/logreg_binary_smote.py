"""
Logistic Regression Binary Classification for Wine Quality (Premium vs Non-Premium).
...
def train_and_evaluate(
    ...
    # Logistic Regression with L2 regularization (l1_ratio=0 is equivalent to L2)
...
def run_experiment(verbose: bool = True) -> dict:
    ...
    if verbose:
        print("\n[Step 7] Training and evaluating Logistic Regression...")

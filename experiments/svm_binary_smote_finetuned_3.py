"""
SVM Binary Classification for Wine Quality (Premium vs Non-Premium) - FINETUNED VERSION 3.
...
1. Uses native SVM class_weight='balanced' instead of SMOTE
...
4. class_weight included in hyperparameter search
...
Model: Support Vector Machine (SVM) with class_weight='balanced'
"""
import sys
import os
...
def train_and_evaluate(
    ...
    if verbose:
        print("\n" + "=" * 60)
        print("SVM BINARY CLASSIFICATION (FINETUNED v3 - class_weight)")
        print("=" * 60)

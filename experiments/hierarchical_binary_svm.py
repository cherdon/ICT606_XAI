"""
Hierarchical Binary Classification for Wine Quality - SVM Version.
...
def run_experiment(verbose: bool = True) -> dict:
    ...
    # Stage 1
    stage1_results = train_svm_model(
    ...
    stage2_results = train_svm_model(
...
def main():
    ...
    print("\n" + "=" * 60)
    print("HIERARCHICAL CLASSIFICATION (SVM) COMPLETE")
    print("=" * 60)

"""
SVM Binary Classification for Wine Quality (Premium vs Non-Premium) - FINETUNED VERSION.
Uses SMOTE for class balancing + Hyperparameter Tuning + Threshold Optimization.

================================================================================
IMPROVEMENTS OVER BASELINE
================================================================================

1. RandomizedSearchCV with 5-fold stratified cross-validation for hyperparameter tuning
2. Decision threshold optimization using precision-recall curve to maximize F1
3. REMOVED class_weight='balanced' (using SMOTE only for class balancing)
...
Model: Support Vector Machine (SVM) - Finetuned
"""
import sys
import os
...
def hyperparameter_tuning(
    ...
    # NOTE: class_weight is NOT included - using SMOTE only for class balancing
    param_distributions = {
        'C': [0.1, 1.0, 10, 100],
    ...
    # Base model - NO class_weight='balanced' (using SMOTE instead)
    base_model = SVC(
...
def train_and_evaluate(
    ...
    if verbose:
        print("\n" + "=" * 60)
        print("SVM BINARY CLASSIFICATION (FINETUNED)")
        print("=" * 60)

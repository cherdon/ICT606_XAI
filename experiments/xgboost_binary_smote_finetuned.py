"""
XGBoost Binary Classification for Wine Quality (is_premium) - FINETUNED VERSION.
Uses SMOTE for handling class imbalance + Hyperparameter Tuning + Threshold Optimization.
...
3. No preprocessing transforms (kept same as baseline - tree models don't require scaling)
...
Model: XGBoost Binary Classifier (Finetuned)
"""
import sys
import os
...
def train_and_evaluate(
    ...
    if verbose:
        print("\n" + "=" * 60)
        print("XGBOOST BINARY CLASSIFICATION (FINETUNED)")
        print("=" * 60)

"""
XGBoost Binary Classification for Wine Quality (is_premium) - REFINED VERSION 2.
Uses SMOTE + Hyperparameter Tuning + Threshold Optimization + Yeo-Johnson + RobustScaler.

================================================================================
IMPROVEMENTS OVER FINETUNED VERSION
================================================================================

1. Added Yeo-Johnson transformation for skewness correction
2. Added RobustScaler for feature scaling
3. Retains hyperparameter tuning and threshold optimization from finetuned version
...
def train_and_evaluate(
    ...
    if verbose:
        print("\n" + "=" * 60)
        print("XGBOOST BINARY CLASSIFICATION (REFINED v2)")
        print("=" * 60)
...
def run_experiment(verbose: bool = True) -> dict:
    ...
    # NEW: Apply Yeo-Johnson transformation

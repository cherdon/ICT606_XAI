"""
SVM Binary Classification for Wine Quality (Premium vs Non-Premium) - REFINED VERSION 2.
...
Model: Support Vector Machine (SVM) - Refined v2
"""
import sys
import os
...
def train_and_evaluate(
    ...
    if verbose:
        print("\n" + "=" * 60)
        print("SVM BINARY CLASSIFICATION (REFINED v2)")
        print("=" * 60)
...
def plot_confusion_matrix(results: dict, output_dir: str, experiment_name: str):
    ...
    plt.text(1.35, 0.5, metrics_text, transform=plt.gca().transAxes, fontsize=10,
             verticalalignment='center', bbox=dict(boxstyle='round', facecolor='plum', alpha=0.5))

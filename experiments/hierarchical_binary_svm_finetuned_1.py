"""
Hierarchical Binary Classification for Wine Quality - SVM with HIGH RECALL Stage 1.
...
def train_svm_stage1_high_recall(
...
def run_experiment(verbose: bool = True) -> dict:
    ...
    # Stage 1 - HIGH RECALL
    stage1_results = train_svm_stage1_high_recall(
...
def main():
    ...
    print("\n" + "=" * 60)
    print("HIERARCHICAL CLASSIFICATION (SVM HIGH RECALL) COMPLETE")
    print("=" * 60)
